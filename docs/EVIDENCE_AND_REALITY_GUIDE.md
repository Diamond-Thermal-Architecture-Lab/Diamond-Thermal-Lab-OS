...
An independent benchmark must commit and hash its blind canonical case and exported baseline before adding source Evidence Objects, Measurement References, or Prediction-Reality Records. The later assessment must report the actual baseline output, including any missed rule or false positive, without rewriting the historical artifacts. This is a repository-level blind-to-outcome protocol, not a prospective double-blind experiment. Draft source-documented measurements remain pending human review and do not provide automatic calibration or engineering-memory promotion.
